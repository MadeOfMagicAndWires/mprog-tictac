...
public class GameAndroidOld extends Game implements View.OnClickListener {

    /**
     * Constructor. Creates a new instance of GameAndroidOld
     * @param boardSize the "cubic" amount of tiles created

     */
    public GameAndroidOld(int boardSize) {
        super(boardSize);
